    ...
    class AWS_Markup {
        ...
        public function markup() {
            ...
            $markup .= '<div class="aws-wrapper">';
                ...
                $markup .= '<label class="screen-reader-text" for="s">Search for:<input  type="text" name="s" value="' . get_search_query() . '" class="aws-search-field" placeholder="' . $placeholder . '" autocomplete="off" /></label>';
